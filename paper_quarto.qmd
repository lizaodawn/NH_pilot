...
To investigate the prominent themes in the India-related content discussed in *Natural History*, methods of collocation analysis and keyword analysis are employed for this study. Both of the analyses rely on the `mclm::assoc_scores` objects of the [mclm](https://github.com/masterclm/mclm) package, which return frequencies and association scores of a certain event in a target context and in a reference context.
