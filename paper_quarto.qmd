...
#| tbl-cap:  Scatterplot of G_signed by absolute frequency
...
**Geographical/Ethnic Group**: india, arabia, indian, ganges, indus, ethiopia, taprobane(G), thence, sail(A)

**People**: alexander, indians, tribe(A), ichthyophagi(G), megasthenes(G)

**Numeric**: hundred, thousand, fifty(A)

**Precious Stone/Gem**: stones, amber, beryls, rock-crystal, glass, beryls(G)
...
4.  $G^2$ signed highly overlapped with that of absolute frequency. (plot of corelation)

5.  list the overlapped keywords

6.  PMI sorting provides more information
