...
Building upon this observation, the study focus is narrowed down to India-related text in *Natural History* to investigate what and how is India described in the work. By delving into the themes associated with Indian region with the methods of collocation and keyword analysis, this study aims to examine the portrayal of India by Pliny the Elder, which potentially shed a light on the spatial perception and imagination of the representative writers and scholars of ancient Rome.

The subsequent sections provide detailed explanation of the methodology and corpus employed, interpretation and discussion of the results of the collocation and keyword analysis, and an overall conclusion responding to the captioned research questions. 
