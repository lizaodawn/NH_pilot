...
[@R-tidyverse] and [@R-mclm] [@R-base] [@R-ggplot2] [@R-leaflet] are the main packages used in this paper. [@dodd2021] [@nappo2017]
...
@tbl-kwtables below shows the top 30 keywords in Indian related texts comparing to other context, respectively sorted by PMI and G_signed.
